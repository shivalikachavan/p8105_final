...
Overall, we found a significant relationship between legalization of sports betting and poor physical/mental health. In our statistical analyses, even if the effect size was small, we still had a small p-value likely due to the size of the BRFSS dataset (~2.7 million observations).
