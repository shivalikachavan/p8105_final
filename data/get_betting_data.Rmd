...
#Save output
write_csv(sb_rev_market_df, file = "./data/clean_data/lsr_sb_rev_market.csv")
write_csv(sb_rev_month_df, file = "./data/clean_data/lsr_sb_rev_month.csv")
write_csv(sb_rev_market_month_df, file = "./data/clean_data/lsr_sb_rev_market_month.csv")
```
...
write_csv(sb_rev_market_df, file = "./data/clean_data/state_legalization_dates.csv")
```
